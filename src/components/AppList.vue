  ...
  <el-row :gutter="5">
    <el-col :lg="responsiveLayout['lg']" :sm="responsiveLayout['sm']" :xs="responsiveLayout['xs']" v-for="item in data" :key="item.id" class="asn-app-list">
      <el-card :body-style="{ padding: '10px 10px' }">
        ...
        <p class="asn-app-name asn-text-overflow">Lungo 1.6.0 防止屏幕休眠sdsdsdsdssdsad</p>
        <p class="asn-app-desc asn-text-overflow">Lungo是一款防止Mac屏幕进入休眠状态的软件，可以满足我们让mac电脑不进入休眠状态的需求。Lungo是一款防止Mac屏幕进入休眠状态的软件，可以满足我们让mac电脑不进入休眠状态的需求</p>
